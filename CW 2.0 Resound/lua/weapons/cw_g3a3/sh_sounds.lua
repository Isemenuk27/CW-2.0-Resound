CustomizableWeaponry:addFireSound("CW_G3A3_FIRE", "^weapons/cw_g3a3/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)
CustomizableWeaponry:addFireSound("CW_G3A3_FIRE_SUPPRESSED", "weapons/cw_g3a3/fire_suppressed.wav", 1, 140, CHAN_STATIC)
