CustomizableWeaponry:addFireSound("CW_SVD_OFFICIAL_FIRE", "^weapons/cw_svd_official/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)

CustomizableWeaponry:addFireSound("CW_SVD_OFFICIAL_FIRE_SUPPRESSED", "weapons/cw_svd_official/fire_suppressed.wav", 1, 140, CHAN_STATIC)
