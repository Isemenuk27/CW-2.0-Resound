CustomizableWeaponry:addFireSound("CW_DEAGLE_FIRE", "^weapons/cw_deagle/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)
CustomizableWeaponry:addFireSound("CW_DEAGLE_FIRE_SUPPRESSED", "weapons/cw_deagle/fire_suppressed.wav", 1, 130, CHAN_STATIC)
