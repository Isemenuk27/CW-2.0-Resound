CustomizableWeaponry:addFireSound("CW_FAMASG2_FIRE", "^weapons/cw_famasg2/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)
CustomizableWeaponry:addFireSound("CW_FAMASG2_SUPPRESSED", "weapons/cw_famasg2/fire_suppressed.wav", 1, 92, CHAN_STATIC)
