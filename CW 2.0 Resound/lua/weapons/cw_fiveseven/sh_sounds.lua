CustomizableWeaponry:addFireSound("CW_FIVESEVEN_FIRE", "^weapons/cw_fiveseven/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)
CustomizableWeaponry:addFireSound("CW_FIVESEVEN_FIRE_SUPPRESSED", "weapons/cw_fiveseven/fire_suppressed.wav", 1, 85, CHAN_STATIC)
