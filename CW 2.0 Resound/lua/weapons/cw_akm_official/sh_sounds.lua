CustomizableWeaponry:addFireSound("CW_AKM_OFFICIAL_FIRE", "^weapons/cw_akm_official/fire.wav", 1, 165, CHAN_STATIC, nil, nil, true)
CustomizableWeaponry:addFireSound("CW_AKM_OFFICIAL_FIRE_SUPPRESSED", "^weapons/cw_akm_official/fire_suppressed.wav", 1, 145, CHAN_STATIC, nil, nil, true)
